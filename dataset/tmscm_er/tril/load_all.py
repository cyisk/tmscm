...
# Load or initialize all TM-SCMs in ER-TRIL
for i in tqdm(
    range(50),
    desc="Loading TM-SCM-ER-TRIL datasets",
    unit="dataset",
):
    # Initialize SCM
